...
| Phase 1 | 🔨 **进行中** | 35/~155 | ~32/155 | PRIM/SCHED/CORE/COMP/MAIN/DSL/LINEAGE/MONITOR 主链路贯通 |
...
| **L1-DSL v0.5** | — | 1 | 声明式 flow + 解释器 + join 融合原语 + 多消费者（[adr/0021](./adr/0021-dsl-v0.md) v0.5 增补）；L1-DSL-1..3 的 v0.5 子集 |
