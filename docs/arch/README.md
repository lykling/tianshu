...
| 声明式 DSL 与血缘 | `tianshu/include/tianshu/dsl/` | ✅ DSL v0 + 血缘 + 切片 + 状态 + record v2 | [modules/dsl.md](./modules/dsl.md) |
...
**对象**：人类贡献者与 AI 代理一视同仁（AI 侧由仓库根 `AGENTS.md` 与 `project-tianshu` skill 强制提醒）。
**时点**：迭代收尾、提交/合并之前。
